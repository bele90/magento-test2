<?php
    class SmashingMagazine_BrandDirectory_Block_Adminhtml_Brand_Grid extends Mage_Adminhtml_Block_Widget_Grid {

        protected function _prepareCollection() {
            $collection = Mage::getResourceModel('smashingmagazine_branddirectory/brand_collection');
            ...
            $this->addColumn('action', array(
                ...
                'actions' => array(
                    array(
                        ...
                        'url' => array(
                            'base' => 'smashingmagazine_branddirectory_admin'.'/brand/edit',
                        ),
                        'field' => 'id'
                    ),
                ),
