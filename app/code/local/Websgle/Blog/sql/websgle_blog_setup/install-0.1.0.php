...
$table = $installer->getConnection()
    ...
    ->addIndex(
        $installer->getIdxName('websgle_blog_post_entity_varchar', array('attribute_id')),
        array('attribute_id')
    )
    ->addIndex(
        $installer->getIdxName('websgle_blog_post_entity_varchar', array('store_id')),
        array('store_id')
    )
    ->addIndex(
        $installer->getIdxName('websgle_blog_post_entity_varchar', array('entity_id')),
        array('entity_id')
    )
    ->addForeignKey(
...
$table = $installer->getConnection()
    ...
    ->addIndex(
        $installer->getIdxName('websgle_blog_post_entity_int', array('attribute_id')),
        array('attribute_id')
    )
    ->addIndex(
        $installer->getIdxName('websgle_blog_post_entity_int', array('store_id')),
        array('store_id')
    )
    ->addIndex(
        $installer->getIdxName('websgle_blog_post_entity_int', array('entity_id')),
        array('entity_id')
    )
    ->addForeignKey(
...
$table = $installer->getConnection()
    ...
    ->addIndex(
        $installer->getIdxName('websgle_blog_post_entity_text', array('attribute_id')),
        array('attribute_id')
    )
    ->addIndex(
        $installer->getIdxName('websgle_blog_post_entity_text', array('store_id')),
        array('store_id')
    )
    ->addIndex(
        $installer->getIdxName('websgle_blog_post_entity_text', array('entity_id')),
        array('entity_id')
    )
    ->addForeignKey(
