<?php
class BlueCom_Swatches_Block_Adminhtml_Catalog_Product_Attribute_Edit_Tab_Super_Config_Grid_Renderer extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Checkbox {
    /**
     * Renders grid column
     *
