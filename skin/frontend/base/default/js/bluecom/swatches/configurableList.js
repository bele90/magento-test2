...
jQuery(document).ready(function(){
    ...
    //for grid of products
    jQuery(".product-shop").each(function(ind,el){
        jQuery(el).find(".btn-cart").click(function(){
            jQuery(el).find(".attr-image").click(function(){
                jQuery(el).find(".input-box").removeClass("requirediv");
            });
            if(!jQuery(el).find(".attr-image").hasClass("attr-image-selected"))
            {
                jQuery(el).find(".input-box").addClass("requirediv");
                return false;
            }
            else
            {
                var newurl = jQuery(el).find(".hiddenurl").html() + jQuery(el).find(".attr-image-selected").attr('data-id');
                setLocation(newurl);
            }
    ...
    jQuery(".products-grid li").each(function(ind,el){
        jQuery(el).find(".btn-cart").click(function(){
            jQuery(el).find(".attr-image").click(function(){
                jQuery(el).find(".input-box").removeClass("requirediv");
            });
